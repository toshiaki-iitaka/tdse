...
try:
    with open('st6.dat', 'w') as f_out:
        ...
        for a_val in plot_x:
            ...
            coefficients = [1.0, +33./10.*iu*a_val, -21./5.*iu*a_val, +39./5.*iu*a_val, -21./5.*iu*a_val, +33./10.*iu*a_val, -1.0]
...
print("Program finished. Results written to st6.dat")
